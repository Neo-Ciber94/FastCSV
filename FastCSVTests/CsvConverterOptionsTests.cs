...
namespace FastCSV.Tests
{
    ...
    public class CsvConverterOptionsTests
    {
        ...
        public void SerializeIncludeFieldTests()
        {
            ...
            Assert.AreEqual($"name,price,Available{System.Environment.NewLine}Battery,50,true", csv);
        }

        [Test]
        public void DeserializeIncludeFieldsTest()
        {
            string csv = $"name,price,Available{System.Environment.NewLine}Battery,50,true";
        ...
        public void SerializeWithSnakeCaseNamingConventionTest()
        {
            ...
            Assert.AreEqual($"current_country,first_name,last_name{System.Environment.NewLine}Japan,Kanna,Kobayashi", csv);
        }

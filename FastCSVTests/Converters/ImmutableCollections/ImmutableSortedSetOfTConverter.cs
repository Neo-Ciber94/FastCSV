...
{
    [TestFixture]
    class ImmutableSortedSetOfTConverterTests
    {
        ...
        {
            var collection = new Container<string>(ImmutableSortedSet.Create(new string[]{ "Spear", "Sword", "Shield" }), 3);
        ...
        record Container<T>(ImmutableSortedSet<T> Items, int Count);
    }
}

...
namespace FastCSV.Converters.Tests
{
    ...
    class QueueOfTConverterTests
    {
        ...
        {
            var collection = new Container<string>(new Queue<string>(new string[] { "Spear", "Sword", "Shield" }), 3);
        ...
        record Container<T>(Queue<T> Items, int Count);
    }
}
